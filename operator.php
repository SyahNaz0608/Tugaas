...
echo "<title>operator dasar in php</title>";

echo "<h1>Macam-macam operator in php</h1>";
...
echo "<h2>Perbandingan equal dan identik</h2>";
...
echo "<h2>Operator Increment dan Decrement</h2>";
